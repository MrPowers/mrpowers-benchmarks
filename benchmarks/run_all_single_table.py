...
# polars_res = polars_groupby_queries.run_benchmarks([df]).rename(columns={"duration": "polars"})
# print(polars_res)
...
res = datafusion_res.join(daft_res, on="task")
print(res)
...
ax.figure.savefig("images/single_table.png")
